...
#### 上报间隔
- 默认 30 秒，适合 Workers Free 下 10 台以内的常规监控
- 10 台 VPS、30 秒上报约为 28,800 次探针请求/天，预留空间给大盘访问和详情页刷新
- 如需更实时，可调到 15 秒；超过 10 台建议提高到 60 秒或升级 Workers Paid
- 前台在线阈值会按上报间隔动态计算，避免提高间隔后误判离线
...
### Worker 请求超限
- 免费套餐每日 10 万次请求
- 10 台以内建议保持默认 30 秒上报；10 台、30 秒约 28,800 次探针请求/天
- 首页大盘默认 15 秒刷新，详情页默认 10 秒刷新，浏览器标签页隐藏时会暂停刷新
- 如果公开大盘访问量较高，建议关闭公开访问、提高上报间隔到 60 秒，或升级 Workers Paid
